...
class Perfil(models.Model):
    user = models.OneToOneField(
        'auth.User', on_delete=models.CASCADE, verbose_name="Usuário", null=False, help_text="Usuário do perfil", related_name="perfil")
    telefone = models.CharField(
        verbose_name="Telefone", max_length=20, null=True, blank=True, help_text="Telefone do usuário")
    endereco = models.OneToOneField(
        Endereco, on_delete=models.SET_NULL, verbose_name="Endereço", null=True, blank=True, help_text="Endereço do usuário", related_name="perfil")
    data_nascimento = models.DateField(
        verbose_name="Data de Nascimento", null=True, blank=True, help_text="Data de nascimento do usuário")
    foto_perfil = models.ImageField(
        verbose_name="Foto de Perfil", upload_to="perfil", null=True, blank=True, help_text="Foto de perfil do usuário")
    cpf = models.CharField(
        verbose_name="CPF", max_length=11, null=True, blank=True, help_text="CPF do usuário")
    profissao = models.CharField(
        verbose_name="Profissão", max_length=100, null=True, blank=True, help_text="Profissão do usuário")
    data_cadastro = models.DateField(
        verbose_name="Data de Cadastro", null=False, blank=False, help_text="Data de cadastro do usuário", auto_now_add=True)
